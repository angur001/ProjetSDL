...
public class Assignment implements Instruction, Expression {
	...
	public boolean collectAndBackwardResolve(HierarchicalScope<Declaration> _scope) {
		boolean o1 = assignable.collectAndBackwardResolve(_scope);
		boolean o2 = value.collectAndBackwardResolve(_scope);
		return o1 && o2;
	}
	...
	public boolean fullResolve(HierarchicalScope<Declaration> _scope) {
		boolean o1 = assignable.fullResolve(_scope);
		boolean o2 = value.fullResolve(_scope);
		return o1 && o2;
	}
