...
public abstract class AbstractArray implements Expression {
	...
	public boolean collectAndBackwardResolve(HierarchicalScope<Declaration> _scope) {
		boolean o1 = array.collectAndBackwardResolve(_scope);
		boolean o2 = index.collectAndBackwardResolve(_scope);
		return o1 && o2;
	...
	public boolean fullResolve(HierarchicalScope<Declaration> _scope) {
		boolean o1 = array.fullResolve(_scope);
		boolean o2 = index.fullResolve(_scope);
		return o1 && o2;
	}
